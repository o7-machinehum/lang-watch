...
// http://www.e-paper-display.com/download_detail/downloadsId=806.html Panel: GDEH0154D67 :
// http://www.e-paper-display.com/products_detail/productId=455.html Controller : SSD1681 :
...
//
// The original code from the author has been slightly modified to improve the performance for
// Watchy Project: Link: https://github.com/sqfmi/Watchy

#include "Display.h"

WatchyDisplay::WatchyDisplay(int16_t cs, int16_t dc, int16_t rst, int16_t busy)
    : GxEPD2_EPD(cs, dc, rst, busy, HIGH, 10000000, WIDTH, HEIGHT, panel, hasColor,
                 hasPartialUpdate, hasFastPartialUpdate) {
    selectSPI(SPI,
              SPISettings(20000000, MSBFIRST, SPI_MODE0));  // Set SPI to 20Mhz (default is 4Mhz)
}
...
void WatchyDisplay::writeImage(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h,
                               bool invert, bool mirror_y, bool pgm) {
    _writeImage(0x24, bitmap, x, y, w, h, invert, mirror_y, pgm);
}

void WatchyDisplay::writeImageForFullRefresh(const uint8_t bitmap[], int16_t x, int16_t y,
...
void WatchyDisplay::writeImageAgain(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w,
                                    int16_t h, bool invert, bool mirror_y, bool pgm) {
    _writeImage(0x24, bitmap, x, y, w, h, invert, mirror_y, pgm);
}

void WatchyDisplay::_writeImage(uint8_t command, const uint8_t bitmap[], int16_t x, int16_t y,
...
void WatchyDisplay::writeImagePart(const uint8_t bitmap[], int16_t x_part, int16_t y_part,
...
void WatchyDisplay::writeImagePartAgain(const uint8_t bitmap[], int16_t x_part, int16_t y_part,
                                        int16_t w_bitmap, int16_t h_bitmap, int16_t x, int16_t y,
                                        int16_t w, int16_t h, bool invert, bool mirror_y,
                                        bool pgm) {
    _writeImagePart(0x24, bitmap, x_part, y_part, w_bitmap, h_bitmap, x, y, w, h, invert, mirror_y,
...
void WatchyDisplay::_writeImagePart(uint8_t command, const uint8_t bitmap[], int16_t x_part,
    ...
    for (int16_t i = 0; i < h1; i++) {
        for (int16_t j = 0; j < w1 / 8; j++) {
            ...
            int16_t idx = mirror_y ? x_part / 8 + j + dx / 8 +
...
void WatchyDisplay::writeImage(const uint8_t* black, const uint8_t* color, int16_t x, int16_t y,
                               int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm) {
    if (black) {
...
void WatchyDisplay::writeImagePart(const uint8_t* black, const uint8_t* color, int16_t x_part,
                                   int16_t y_part, int16_t w_bitmap, int16_t h_bitmap, int16_t x,
                                   int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y,
                                   bool pgm) {
    if (black) {
        writeImagePart(black, x_part, y_part, w_bitmap, h_bitmap, x, y, w, h, invert, mirror_y,
                       pgm);
    }
}

void WatchyDisplay::writeNative(const uint8_t* data1, const uint8_t* data2, int16_t x, int16_t y,
                                int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm) {
    if (data1) {
...
void WatchyDisplay::drawImage(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h,
                              bool invert, bool mirror_y, bool pgm) {
...
void WatchyDisplay::drawImagePart(const uint8_t bitmap[], int16_t x_part, int16_t y_part,
                                  int16_t w_bitmap, int16_t h_bitmap, int16_t x, int16_t y,
                                  int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm) {
    writeImagePart(bitmap, x_part, y_part, w_bitmap, h_bitmap, x, y, w, h, invert, mirror_y, pgm);
    refresh(x, y, w, h);
    writeImagePartAgain(bitmap, x_part, y_part, w_bitmap, h_bitmap, x, y, w, h, invert, mirror_y,
                        pgm);
}

void WatchyDisplay::drawImage(const uint8_t* black, const uint8_t* color, int16_t x, int16_t y,
                              int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm) {
    if (black) {
...
void WatchyDisplay::drawImagePart(const uint8_t* black, const uint8_t* color, int16_t x_part,
                                  int16_t y_part, int16_t w_bitmap, int16_t h_bitmap, int16_t x,
                                  int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y,
                                  bool pgm) {
    if (black) {
...
void WatchyDisplay::drawNative(const uint8_t* data1, const uint8_t* data2, int16_t x, int16_t y,
                               int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm) {
    if (data1) {
