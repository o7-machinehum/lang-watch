...
bool BMA423::begin(bma4_com_fptr_t readCallBlack, bma4_com_fptr_t writeCallBlack,
...
void BMA423::shutDown() { bma4_set_advance_power_save(BMA4_DISABLE, &__devFptr); }
...
bool BMA423::resetStepCounter() { return BMA4_OK == bma423_reset_step_counter(&__devFptr); }
...
bool BMA423::getINT() { return bma423_read_int_status(&__IRQ_MASK, &__devFptr) == BMA4_OK; }
...
bool BMA423::isStepCounter() { return (bool)(BMA423_STEP_CNTR_INT & __IRQ_MASK); }
...
bool BMA423::isAnyNoMotion() { return (bool)(BMA423_ANY_NO_MOTION_INT & __IRQ_MASK); }
...
bool BMA423::enableAnyNoMotionInterrupt(bool en) {
    return (BMA4_OK ==
            bma423_map_interrupt(BMA4_INTR1_MAP, BMA423_ANY_NO_MOTION_INT, en, &__devFptr));
}
